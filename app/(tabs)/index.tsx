...
export default function SearchScreen() {
  ...
  const { movies, isLoading, error, searchMovies, loadPopularMovies } =
    useSearchViewModel();
      ...
      >
        ...
        >
          ...
          <TextInput
            ...
            accessibilityLabel="Movie search input field"
            accessibilityHint="Type the name of a movie to search for it"
          ...
          {searchQuery.length > 0 && (
            <TouchableOpacity
              ...
              accessibilityHint="Clears the movie search field"
            >
              <Ionicons
                name="close-circle"
                size={20}
      ...
      <View style={styles.content}>
        ...
        {isLoading ? (
          ...
          <ErrorMessage
            message={error}
            onRetry={() =>
              searchQuery ? searchMovies(searchQuery) : loadPopularMovies()
            }
          />
        ) : movies.length === 0 ? (
...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontSize: 16, marginLeft: 8, borderRadius: 16 },
